        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                Polityka prywatności Backblaze dostępna jest pod adresem:{' '}
                <a href="https://www.backblaze.com/company/privacy.html" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                  backblaze.com/company/privacy.html
                </a>.
              </li>
          ...
          <section>
            ...
            <p className="mb-3">Serwis używa plików cookies w następujących celach:</p>
            <ul className="list-disc list-inside space-y-2">
